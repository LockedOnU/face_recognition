...
def download_image():
    while True:
        ...
        '''
        names = ['Michy Batshuayi', 'Thorgan Hazard', 'Romelu Lukaku', 'Dries Mertens', 'Eden Hazard',
                 'Marouane Fellaini', 'Nacer Chadli', 'Adnan Januzaj', 'Mousa Dembele', 'Yannick Carrasco',
                 'Axel Witsel', 'Kevin De Bruyne', 'Youri Tielemans', 'Jan Vertonghen', 'Vincent Kompany',
                 'Thomas Vermaelen', 'Dedryck Boyata', 'Leander Dendoncker', 'Toby Alderweireld', 'Thomas Meunier',
